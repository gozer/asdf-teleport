...
DOWNLOAD_URL="https://cdn.teleport.dev"
TOOL_NAME="teleport"
...
list_all_versions() {
  ...
  # Change this function if teleport has other means of determining installable versions.
  list_github_tags
}
...
install_version() {
  ...
  (
    ...
    # TODO: Asert teleport executable exists.
    local tool_cmd
